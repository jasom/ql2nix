...
{ buildLispPackage, stdenv, fetchurl, lisp-project_cl-cffi-gtk, 
  gnome3,   lisp_closer-mop, lisp_bordeaux-threads, lisp_trivial-garbage, lisp_iterate, lisp_cffi,  
  ccl, clisp, sbcl,  
...
in
  buildLispPackage {
      propagatedBuildInputs = [ lisp_closer-mop lisp_bordeaux-threads lisp_trivial-garbage lisp_iterate lisp_cffi gnome3.gtk ];
      inherit stdenv;
