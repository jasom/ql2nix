...
{ buildLispPackage, stdenv, fetchurl, lisp-project_fare-quasiquote, 
   lisp_fare-quasiquote, lisp_named-readtables,  
  sbcl, clisp, ccl,  
...
in
  buildLispPackage {
      propagatedBuildInputs = [ lisp_fare-quasiquote lisp_named-readtables  ];
      inherit stdenv;
      systemName = "fare-quasiquote-readtable";
      
      sourceProject = "${lisp-project_fare-quasiquote}";
      patches = [];
      lisp_dependencies = "${lisp_fare-quasiquote} ${lisp_named-readtables}";
