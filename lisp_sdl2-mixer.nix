...
{ buildLispPackage, stdenv, fetchurl, lisp-project_cl-sdl2-mixer, 
  SDL2_mixer,   lisp_sdl2, lisp_cl-autowrap, lisp_defpackage-plus, lisp_alexandria,  
  sbcl, ccl,  
...
in
  buildLispPackage {
      propagatedBuildInputs = [ lisp_sdl2 lisp_cl-autowrap lisp_defpackage-plus lisp_alexandria SDL2_mixer ];
      inherit stdenv;
